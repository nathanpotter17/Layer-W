...
const WallocFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_walloc_free(ptr >>> 0, 1));

export class Walloc {

    static __wrap(ptr) {
        ptr = ptr >>> 0;
        const obj = Object.create(Walloc.prototype);
        obj.__wbg_ptr = ptr;
        WallocFinalization.register(obj, obj.__wbg_ptr, obj);
        return obj;
    }
    ...
    __destroy_into_raw() {
        ...
        this.__wbg_ptr = 0;
        WallocFinalization.unregister(this);
        return ptr;
    }

    free() {
        const ptr = this.__destroy_into_raw();
        wasm.__wbg_walloc_free(ptr, 0);
    }
    /**
     * @returns {Walloc}
     */
    static new() {
        const ret = wasm.walloc_new();
    ...
    set_base_url(url) {
        try {
            ...
            wasm.walloc_set_base_url(retptr, this.__wbg_ptr, ptr0, len0);
    ...
    /**
     * @param {string} path
     * @param {number} asset_type
     * @returns {Promise<any>}
     */
    load_asset(path, asset_type) {
        const ptr0 = passStringToWasm0(path, wasm.__wbindgen_export_1, wasm.__wbindgen_export_2);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.walloc_load_asset(this.__wbg_ptr, ptr0, len0, asset_type);
     ...
     */
    test_fetch_json() {
        const ret = wasm.walloc_test_fetch_json(this.__wbg_ptr);
        return takeObject(ret);
    }
    /**
     * @param {string} path
    ...
    evict_asset(path) {
        try {
            ...
            const ptr0 = passStringToWasm0(path, wasm.__wbindgen_export_1, wasm.__wbindgen_export_2);
            const len0 = WASM_VECTOR_LEN;
            wasm.walloc_evict_asset(retptr, this.__wbg_ptr, ptr0, len0);
            var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
            var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
            if (r1) {
                throw takeObject(r0);
    ...
    get_asset(path) {
        try {
            ...
            const ptr0 = passStringToWasm0(path, wasm.__wbindgen_export_1, wasm.__wbindgen_export_2);
            const len0 = WASM_VECTOR_LEN;
            wasm.walloc_get_asset(retptr, this.__wbg_ptr, ptr0, len0);
            var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
            var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
     ...
     * @returns {Uint8Array}
     */
    get_memory_view(offset, length) {
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            wasm.walloc_get_memory_view(retptr, this.__wbg_ptr, offset, length);
            var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
            var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
            var r2 = getDataViewMemory0().getInt32(retptr + 4 * 2, true);
            if (r2) {
     ...
     */
    allocate(size) {
        const ret = wasm.walloc_allocate(this.__wbg_ptr, size);
        return ret >>> 0;
    }
    /**
     * @param {number} offset
     */
    free(offset) {
        wasm.walloc_free(this.__wbg_ptr, offset);
    }
    /**
     * @param {number} offset
     * @param {Uint8Array} data
     */
    copy_from_js(offset, data) {
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            wasm.walloc_copy_from_js(retptr, this.__wbg_ptr, offset, addBorrowedObject(data));
            var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
            var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
            if (r1) {
                throw takeObject(r0);
     ...
     * @returns {Uint8Array}
     */
    copy_to_js(offset, length) {
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            wasm.walloc_copy_to_js(retptr, this.__wbg_ptr, offset, length);
            var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
            var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
            var r2 = getDataViewMemory0().getInt32(retptr + 4 * 2, true);
            if (r2) {
...
async function __wbg_init(module_or_path) {
    ...
    if (typeof module_or_path === 'undefined') {
        module_or_path = new URL('walloc_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
