...
export const walloc_evict_asset: (a: number, b: number, c: number, d: number) => void;
export const walloc_get_asset: (a: number, b: number, c: number, d: number) => void;
export const walloc_get_memory_view: (a: number, b: number, c: number, d: number) => void;
