...
export interface InitOutput {
  ...
  readonly closure7_externref_shim: (a: number, b: number, c: any) => void;
  ...
  readonly closure2213_externref_shim: (a: number, b: number, c: any) => void;
  readonly _dyn_core__ops__function__FnMut_____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h8ad3f2e499790093: (a: number, b: number) => void;
  readonly closure2294_externref_shim: (a: number, b: number, c: any) => void;
